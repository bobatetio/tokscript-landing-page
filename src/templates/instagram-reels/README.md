# Instagram Reels Landing Page Template

This is a self-contained landing page template for the Instagram Reels transcript generator.

## Quick Start for Backend Engineers

### 1. Copy this folder
Copy the entire `instagram-reels/` folder to your project.
...
The page uses the CSS class `instagram-landing-page` for theming.
Styles are defined in `/src/App.scss`.

The Instagram theme uses a warm orange/peach gradient color palette.
