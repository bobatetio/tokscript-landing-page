                ...
                <div className="row">
                  ...
                  <div className="col-lg-6 align-self-center">
                    <div className="img-card mt-4">
                      <Image src={bulkProcess} alt="Bulk transcript processing interface showing multiple YouTube Shorts URLs being imported" loading="lazy" sizes="(max-width: 768px) 100vw, 50vw" />
                    </div>
                  </div>
                </div>
              </div>
