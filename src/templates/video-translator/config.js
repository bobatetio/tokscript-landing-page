/**
 * YouTube Shorts Landing Page Configuration
 *
...
export const config = {
  ...
  themeClass: "youtube-landing-page", // CSS class for theming
  ...
  branding: {
    siteName: "TokScript",
    headline: "Shorts Transcript Generator",
  ...
  freePlan: {
    ...
    price: "$0",
    features: [
      "Download 5 YouTube Shorts Transcripts /day",
  ...
  // ===========================================
  seo: {
    title: "YouTube Transcript Generator - TokScript",
    description: "Instantly generate transcripts from any YouTube Shorts video. Free tool for creators, marketers, and content professionals.",
    keywords: ["youtube transcript generator", "youtube shorts transcript", "shorts captions", "video to text"],
  },
  ...
  disclaimer: {
    ...
    sections: [
      {
        title: null,
        content: "Download Video Transcripts (captions) For Free. Instantly, without uploading any files! Quick and simple. No catch. Download any video's captions, transcripts, and words for your YouTube Shorts, TikTok, and Instagram Reels videos in seconds.",
      },
      {
      ...
      {
        title: "AI:",
        content: "Easily download any YouTube Shorts, TikTok, or Reels video's video transcript and subtitles so you can use it with any of your favorite Al companies like ChatGPT, Gemini, Claude, and more to easily create User Generated Video Scripts and ideas for your next video!",
      },
    ],
  },
};
