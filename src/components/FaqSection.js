...
export default function FaqSection({ faqData, title, subtitle, bottomText }) {
  ...
  return (
    <section className="faq-main-section" id="faqs">
      <div className="container">
        <div className="title-section">
          <h2>{title || "Frequently Asked Questions"}</h2>
          <p>{subtitle || "Your questions, answered."}</p>
        </div>
        ...
        <div className="bottom-text">
          <strong className="large">
            {bottomText || <>Have more questions? Click <Link href="https://help.tokscript.com/" target="_blank">here</Link> to visit our{" "}<br />support docs.</>}
          </strong>
        </div>
      </div>
    </section>
