// Auto-generated. Static body HTML, runtime script, and JSON-LD for the claude page.
export const bodyHtml = `<!-- ① HERO -->
<section id="hero">
  <div class="hero-aurora"><img src="/assets/aurora-hero-494.png" alt="" /></div>
  <div class="hero-inner">
    <div class="hero-left">
      <div class="hero-badge">
        <img src="/assets/88f10f22-a73a-4253-bd1f-cc49f3fe7c83.svg" alt="" />
...
<section id="tools">
  <div class="tools-inner">
    <div class="tools-header-block">
      <img class="tools-header-bg" src="/assets/4b4a8b9d-2113-4a2a-aaf8-f45a920bf6cf.png" alt="" />
...
<div class="pfs-section">
  <div class="pfs-blob pfs-blob-tiktok"><img src="/assets/tt-blob.png" alt=""></div>
  <div class="pfs-inner">
    <div class="pfs-header">
      <div class="pfs-pill tiktok">
        <img src="/assets/tt-badge-icon.svg" alt="TikTok" style="height:12px;width:12px;">
        TikTok
      </div>
    ...
    <div class="pfs-grid-outer">
      <div class="pfs-grid pfs-grid-3">
        <div class="pfs-card has-desc">
          ...
          <div class="pfs-card-img"><img src="/assets/tt-card-transcripts2.png" alt="Transcripts"></div>
        ...
        <div class="pfs-card has-desc">
          ...
          <div class="pfs-card-img"><img src="/assets/tt-card-engagement2.png" alt="Engagement Stats"></div>
        ...
        <div class="pfs-card has-desc">
          ...
          <div class="pfs-card-img"><img src="/assets/tt-card-imports2.png" alt="Collection Imports"></div>
        ...
        <div class="pfs-card has-desc">
          ...
          <div class="pfs-card-img"><img src="/assets/tt-card-bulk2.png" alt="Bulk Processing"></div>
...
<div class="pfs-section">
  <div class="pfs-blob pfs-blob-instagram"><img src="/assets/ig-blob3.png" alt=""></div>
  <div class="pfs-inner">
    <div class="pfs-header">
      <div class="pfs-pill instagram">
        <img src="/assets/ig-badge-icon.png" alt="Instagram Reels" style="height:12px;width:12px;object-fit:contain;">
        Instagram Reels
      </div>
    ...
    <div class="pfs-grid-outer">
      <div class="pfs-grid pfs-grid-ytl">
        ...
        <div class="pfs-card has-desc">
          <img class="pfs-card-bg" src="/assets/ig-card-bg2.png" alt="">
          <p class="pfs-card-title">Engagement Stats</p>
          <div class="pfs-card-img"><img src="/assets/ig-card-engagement2.png" alt="Engagement Stats"></div>
        ...
        <div class="pfs-card has-desc">
          <img class="pfs-card-bg" src="/assets/ig-card-bg2.png" alt="">
          <p class="pfs-card-title">Bulk Processing</p>
          <div class="pfs-card-img"><img src="/assets/ig-card-bulk2.png" alt="Bulk Processing"></div>
        ...
        <div class="pfs-card has-desc">
          ...
          <div class="pfs-card-img"><img src="/assets/ig-card-crossplatform2.png" alt="Cross-Platform Analysis"></div>
...
<div class="pfs-section">
  <div class="pfs-blob pfs-blob-youtube"><img src="/assets/ig-blob.png" alt=""></div>
  <div class="pfs-inner">
    <div class="pfs-header">
      <div class="pfs-pill youtube">
        <img src="/assets/yts-badge-icon.png" alt="YouTube Shorts" style="height:14px;width:11px;object-fit:contain;">
        YouTube Shorts
      </div>
    ...
    <div class="pfs-grid-outer">
      <div class="pfs-grid pfs-grid-2">
        <div class="pfs-card">
          <img class="pfs-card-bg" src="/assets/yt-card-bg.png" alt="">
          <p class="pfs-card-title">Full Transcripts</p>
          <div class="pfs-card-img"><img src="/assets/yt-card-transcripts.png" alt="Full Transcripts"></div>
        </div>
        <div class="pfs-card">
          <img class="pfs-card-bg" src="/assets/yt-card-bg.png" alt="">
          <p class="pfs-card-title">Timestamps</p>
          <div class="pfs-card-img"><img src="/assets/yt-card-timestamp.png" alt="Timestamps"></div>
        </div>
        <div class="pfs-card">
          <img class="pfs-card-bg" src="/assets/yt-card-bg.png" alt="">
          <p class="pfs-card-title">Content Repurpose</p>
          <div class="pfs-card-img"><img src="/assets/yt-card-repurpose.png" alt="Content Repurpose"></div>
        </div>
        <div class="pfs-card">
          <img class="pfs-card-bg" src="/assets/yt-card-bg.png" alt="">
          <p class="pfs-card-title">Research at Scale</p>
          <div class="pfs-card-img"><img src="/assets/yt-card-research.png" alt="Research at Scale"></div>
        </div>
      </div>
    </div>
    <div class="pfs-cta">
...
<div class="pfs-section">
  <div class="pfs-blob pfs-blob-youtube"><img src="/assets/ytl-blob.png" alt=""></div>
  <div class="pfs-inner">
    <div class="pfs-header">
      <div class="pfs-pill youtube">
        <img src="/assets/ytl-badge-icon2.svg" alt="YouTube" style="width:14.6px;height:10.2px;">
        YouTube Longs
      </div>
    ...
    <div class="pfs-grid-outer">
      <div class="pfs-grid pfs-grid-ytl">
        ...
        <div class="pfs-card has-desc">
          ...
          <div class="pfs-card-img"><img src="/assets/ytl-card-timestamp.png" alt="Timestamp Support"></div>
        ...
        <div class="pfs-card has-desc">
          <img class="pfs-card-bg" src="/assets/ytl-card-bg.png" alt="">
          <p class="pfs-card-title">Research At Scale</p>
          <div class="pfs-card-img"><img src="/assets/ytl-card-research.png" alt="Research At Scale"></div>
          <p class="pfs-card-desc">Drop a batch of links. Every transcript, every stat, returned together.</p>
        </div>
        <div class="pfs-card has-desc">
          <img class="pfs-card-bg" src="/assets/ytl-card-bg.png" alt="">
          <p class="pfs-card-title">Podcast And Interview Analysis</p>
          <div class="pfs-card-img"><img src="/assets/ytl-card-podcast.png" alt="Podcast And Interview Analysis"></div>
...
<section id="problem-what-changes">
  <div class="pwc-inner">
    ...
    <div class="pwc-row">
      ...
      <div class="pwc-card-wrap">
        <img class="pwc-card-img" src="/assets/pwc-changes.png" alt="" />
      </div>
    </div>
...
<section id="cta-oneplan">
  <div class="ctap-outer">
    ...
    <img class="ctap-bg" src="/assets/47e21646-b87b-421b-a89d-1f456aab3895.png" alt="" />
    <img class="ctap-deco-left" src="/assets/47e21646-b87b-421b-a89d-1f456aab3895.png" alt="" />
    <img class="ctap-deco-right" src="/assets/47e21646-b87b-421b-a89d-1f456aab3895.png" alt="" />
...
<footer class="ft-root">
  <div class="ft-top">
    <div class="ft-brand">
      <div class="ft-brand-logo"><img src="/assets/ffb50184-1438-4481-a73d-44c4a8514de6.png" alt="TokScript" style="width:140px;height:56px;object-fit:contain;" /></div>
      <p class="ft-brand-desc">The most advanced TikTok transcription tool. Turn your videos into accurate transcripts instantly with AI-powered technology.</p>
    </div>
    <div class="ft-nav">
      <div class="ft-nav-col">
        <span class="ft-nav-head">Product</span>
        <div class="ft-nav-links"><a href="#">Features</a><a href="/pricing">Pricing</a><a href="#">API</a><a href="/mcp">Integrations</a><a href="#">Legal</a></div>
      </div>
      <div class="ft-nav-col">
        <span class="ft-nav-head">MCP</span>
        <div class="ft-nav-links"><a href="/mcp">Overview</a><a href="/claude">Claude</a><a href="/chatgpt">ChatGPT</a></div>
      </div>
      <div class="ft-nav-col">
        <span class="ft-nav-head">Company</span>
        <div class="ft-nav-links"><a href="#">About</a><a href="#">Contact</a><a href="#">Privacy</a><a href="#">Terms</a><a href="https://feedback.tokscript.com/help/collections/claude-and-chatgpt-integration-mcp">Help Center</a></div>
      </div>
    </div>
  </div>
  <div class="ft-bottom">
    <div class="ft-bottom-inner">
      <div class="ft-social">
        <a href="#"><img src="/assets/807318b9-14ed-4d3f-b421-c6a60333ace1.svg" alt="X" style="width:20px;height:20px;object-fit:contain;" /></a>
        <a href="#"><img src="/assets/807318b9-14ed-4d3f-b421-c6a60333ace1.svg" alt="Facebook" style="width:20px;height:20px;object-fit:contain;" /></a>
        <a href="#"><img src="/assets/e7685dfb-7af5-4d9a-b482-40ac99e4a6f6.svg" alt="LinkedIn" style="width:20px;height:20px;object-fit:contain;" /></a>
        <a href="#"><img src="/assets/c6799280-3916-4071-97fa-a3454ba4316f.svg" alt="Instagram" style="width:20px;height:20px;object-fit:contain;" /></a>
      </div>
      <span class="ft-copyright">© 2025 TokScript. All rights reserved.</span>
    </div>
    <div class="ft-disclaimer">
      <p><strong style="color:#9ca3af;">LEGAL DISCLAIMER:</strong> <span style="color:#555;">Tokscript is not affiliated with, endorsed by, or sponsored by TikTok, TikTok USDS Joint Venture LLC, ByteDance, Instagram, Meta, YouTube, or Google. All trademarks belong to their respective owners.</span></p>
    </div>
  </div>
</footer>
`;

export const pageScript = `// How It Works accordion
document.querySelectorAll('.hiw2-step').forEach(step => {
  step.addEventListener('click', () => {
    document.querySelectorAll('.hiw2-step').forEach(s => s.classList.remove('active'));
...
window.copyUrl = function() {
  const btn = document.getElementById('urlCopy');
  if (!btn) return;
  navigator.clipboard.writeText('https://api.tokscript.com/mcp').catch(() => {});
  btn.innerHTML = '<svg width="15" height="15" viewBox="0 0 15 15" fill="none"><path d="M2.5 8L5.5 11L12.5 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg> Copied!';
  btn.classList.add('ok');
  setTimeout(() => { btn.innerHTML = '<span style="display:inline-flex;align-items:center;justify-content:center;width:15px;height:15px;flex-shrink:0;"><img src="https://www.figma.com/api/mcp/asset/07184b29-b259-4524-a9ff-5945239d4623" alt="" style="width:15px;height:15px;object-fit:contain;display:block;" /></span> Copy'; btn.classList.remove('ok'); }, 2000);
};

window.copyCtaUrl = function(btn) {
  navigator.clipboard.writeText('https://api.tokscript.com/mcp').catch(() => {});
  btn.textContent = '✓ Copied!';
  setTimeout(() => { btn.innerHTML = '<svg width="12" height="12" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 01-2-2V4a2 2 0 012-2h9a2 2 0 012 2v1"/></svg> Copy URL'; }, 2000);
};
...
document.querySelectorAll('.plat-tab').forEach(tab => {
  tab.addEventListener('click', () => {
    ...
    const panel = document.querySelector(\`.plat-panel[data-panel="\${target}"]\`);
    if (panel) panel.classList.add('active');
  });
});

// Platform logo rotation
(function() {
  const platforms = [
    '<img src="/assets/logo-tiktok2.png" alt="TikTok" class="platform-logo-sm">',
    '<img src="/assets/logo-youtube2.png" alt="YouTube" class="platform-logo-sm">',
    '<img src="/assets/logo-instagram2.png" alt="Instagram" class="platform-logo">',
  ];
  let idx = 0;
  const el = document.getElementById('platform-rotate');
  if (!el) return;
  setInterval(function() {
    el.classList.add('fade-out');
    setTimeout(function() {
      idx = (idx + 1) % platforms.length;
      el.innerHTML = platforms[idx];
      el.classList.remove('fade-out');
    }, 220);
  }, 2000);
})();

window.copyUrlBar = function(btn) {
  navigator.clipboard.writeText('https://api.tokscript.com/mcp').catch(() => {});
  btn.innerHTML = '<svg width="15" height="15" viewBox="0 0 15 15" fill="none"><path d="M2.5 8L5.5 11L12.5 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg> Copied!';
  btn.classList.add('ok');
  setTimeout(() => {
    btn.innerHTML = '<span style="display:inline-flex;align-items:center;justify-content:center;width:15px;height:15px;flex-shrink:0;"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 01-2-2V4a2 2 0 012-2h9a2 2 0 012 2v1"/></svg></span> Copy';
    btn.classList.remove('ok');
  }, 2000);
};

window.copyHeroUrl = function(btn) {
  navigator.clipboard.writeText('https://api.tokscript.com/mcp').catch(() => {});
  btn.textContent = '✓ Copied!';
  setTimeout(() => { btn.innerHTML = '<svg width="13" height="13" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 01-2-2V4a2 2 0 012-2h9a2 2 0 012 2v1"/></svg> Copy'; }, 2000);
};

(function() {
  const words = ['TikTok', 'YouTube', 'Instagram'];
  let idx = 0;
  const el = document.getElementById('platformSwitch');
  if (!el) return;
  setInterval(function() {
...
export const jsonLd = "{\"@context\":\"https://schema.org\",\"@graph\":[{\"@type\":\"SoftwareApplication\",\"name\":\"TokScript for Claude\",\"applicationCategory\":\"BusinessApplication\",\"operatingSystem\":\"Web\",\"description\":\"Connect TokScript to Claude and pull transcripts, engagement stats, video downloads, and creator data from TikTok, Instagram Reels, YouTube Shorts, and YouTube.\",\"offers\":[{\"@type\":\"Offer\",\"price\":\"0\",\"priceCurrency\":\"USD\",\"name\":\"Free Plan\"},{\"@type\":\"Offer\",\"price\":\"39\",\"priceCurrency\":\"USD\",\"billingDuration\":\"P1Y\",\"name\":\"Pro Plan\"}],\"url\":\"https://tokscript.com/claude\"},{\"@type\":\"HowTo\",\"name\":\"How to connect TokScript to Claude\",\"step\":[{\"@type\":\"HowToStep\",\"position\":1,\"text\":\"Open Claude Settings, go to Integrations, click Add More.\"},{\"@type\":\"HowToStep\",\"position\":2,\"text\":\"Paste the connection link: https://api.tokscript.com/mcp\"},{\"@type\":\"HowToStep\",\"position\":3,\"text\":\"Sign in with Google to authorize the connection.\"},{\"@type\":\"HowToStep\",\"position\":4,\"text\":\"Start dropping links from TikTok, Instagram, YouTube Shorts, or YouTube.\"}]},{\"@type\":\"FAQPage\",\"mainEntity\":[{\"@type\":\"Question\",\"name\":\"What platforms does TokScript support inside Claude?\",\"acceptedAnswer\":{\"@type\":\"Answer\",\"text\":\"TokScript works with TikTok, Instagram Reels, YouTube Shorts, and full-length YouTube videos inside Claude.\"}},{\"@type\":\"Question\",\"name\":\"How do I connect TokScript to Claude?\",\"acceptedAnswer\":{\"@type\":\"Answer\",\"text\":\"Open Claude Settings, go to Integrations, click Add More, and paste https://api.tokscript.com/mcp. Sign in and you're connected in about 30 seconds.\"}}]}]}";
