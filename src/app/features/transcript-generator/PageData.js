    ...
    <div style={{ width: '280px', height: '180px', background: '#0d0d0d', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.08)', padding: '16px', position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', gap: '12px', boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.1), 0 10px 30px rgba(0,0,0,0.5)' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
          <Zap size={14} color="#00f2ea" />
          <span style={{ fontSize: '11px', color: '#fff', fontWeight: '500' }}>Extracting...</span>
        </div>
        <span style={{ fontSize: '10px', color: '#00f2ea', fontFamily: 'monospace' }}>1.2s</span>
      </div>
      ...
      <div style={{ flex: 1, background: '#1a1a1a', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.05)', padding: '12px', position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        ...
        <motion.div 
          ...
          style={{ position: 'absolute', top: 0, bottom: 0, width: '2px', background: '#00f2ea', boxShadow: '0 0 12px #00f2ea', zIndex: 10 }}
        />
    ...
    <div style={{ width: '280px', height: '180px', background: '#0d0d0d', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.08)', padding: '16px', display: 'flex', gap: '16px', flexDirection: 'column', boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.1), 0 10px 30px rgba(0,0,0,0.5)' }}>
      ...
      <div style={{ flex: 1, background: '#1a1a1a', border: '1px solid rgba(255,255,255,0.05)', borderRadius: '8px', padding: '12px', position: 'relative' }}>
        ...
        <motion.div
          ...
          style={{ position: 'absolute', bottom: '12px', right: '12px', background: '#00f2ea', color: '#020617', padding: '6px 10px', borderRadius: '6px', display: 'flex', alignItems: 'center', gap: '6px', cursor: 'pointer', boxShadow: '0 4px 12px rgba(0, 242, 234, 0.4)' }}
        >
          <Copy size={12} />
      ...
      <main className="ts-main">
        ...
        <section className="ts-hero">
          <div className="ts-hero-bg">
            ...
            <div className="ts-glow-orb ts-glow-orb-1" style={{ background: '#00f2ea' }}></div>
          </div>
          
          <div className="ts-container">
            <div className="ts-hero-split">
              <div className="ts-hero-content">
                <div className="ts-kicker-badge" style={{ borderColor: 'rgba(0, 242, 234, 0.3)', background: 'rgba(0, 242, 234, 0.1)' }}>
                  <FileText size={14} color="#00f2ea" />
                ...
                <div className="ts-hero-cta-wrap">
                  <a href="/" style={{ background: '#00f2ea', color: '#020617', padding: '16px 24px', borderRadius: '8px', fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '8px', textDecoration: 'none', boxShadow: '0 4px 14px rgba(0, 242, 234, 0.4)' }}>
                ...
                <HoverStateWrapper className="ts-cv-side ts-cv-new">
                  {(hovering) => (
                    <>
                      ...
                      <div className="ts-cv-text">
                        <div className="ts-cv-kicker" style={{ color: '#00f2ea' }}>TokScript</div>
        ...
        <section className="ts-timeline-section">
          ...
          <div className="ts-container">
            ...
            <div className="ts-animated-timeline">
              <div className="ts-timeline-line"><div className="ts-timeline-line-glow" style={{ background: 'linear-gradient(to bottom, #00f2ea, #0284c7)' }}></div></div>
                  ...
                  {(hovering) => (
                    <>
                      <div className="ts-step-node-wrap">
                        <div className="ts-step-node" style={hovering ? { borderColor: '#00f2ea', background: '#083344', color: '#fff', transform: 'scale(1.1)', boxShadow: '0 0 20px rgba(0,242,234,0.4)' } : {}}>{i + 1}</div>
                      </div>
        ...
        <section className="ts-bento-section">
          <div className="ts-bg-aurora" style={{ background: 'radial-gradient(ellipse at 50% 0%, rgba(0,242,234,0.15) 0%, transparent 70%)' }}></div>
          <div className="ts-container">
            ...
            <div className="ts-bento-grid-3" style={{ marginTop: '48px' }}>
              <HoverStateWrapper className="ts-feature-card-v4-wrap">
                {(hovering) => (
                  <>
                    <div className="ts-card-graphic" style={{ height: '240px', background: 'radial-gradient(ellipse at center, rgba(0, 242, 234, 0.15) 0%, transparent 70%)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                       <AnimatedUrlImport hovering={hovering} />
                    </div>
                    <div className="ts-card-text-content">
                      <div className="ts-kicker" style={{ color: '#00f2ea' }}>Feature</div>
        ...
        <section className="ts-section ts-final-cta" style={{ background: '#020617' }}>
          <div className="ts-container ts-container-narrow">
            <div className="ts-cta-box">
              <div className="ts-cta-glow" style={{ background: 'radial-gradient(ellipse at top, rgba(0, 242, 234, 0.4) 0%, transparent 70%)' }}></div>
              ...
              <a href="/" className="ts-btn-primary" style={{ background: '#00f2ea', color: '#020617', border: 'none' }}>Get Your First Transcript →</a>
            </div>
          </div>
        </section>
